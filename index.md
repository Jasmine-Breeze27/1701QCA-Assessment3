...
This is the mood cube; a tangible object that can be oriented in order to express mood or an emotional state. It uses an accelerometer to control the colour of an RGB LED, making the mood cube's trigger orientation-based. This product is made for anyone who wants functionality and fun all in one! The mood cube can act as a desk light with its normal yellow light or illuminate your room with the colour of your choice. The way you use it is up to you.
...
[![Image](thumbnail.jpg)](https://www.youtube.com/watch?v=myd_2swjDM4)
